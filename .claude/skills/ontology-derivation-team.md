...
1. **ICOS Profiler** — Profile `/Users/karnst/Documents/Accelnet/Accelnet/Downloads/geri-data/icos/data/` (39 CSV files, European flux towers)
2. **SAEON Profiler** — Profile `/Users/karnst/Documents/Accelnet/Accelnet/Downloads/geri-data/saeon/` (South African flux towers)
3. **eLTER Profiler** — Profile `/Users/karnst/Documents/Accelnet/Accelnet/Downloads/geri-data/elter/` (European multi-format: CSV, Parquet, Excel)
4. **TERN Profiler** — Profile `/Users/karnst/Documents/Accelnet/Accelnet/Downloads/geri-data/tern/` (Australian NetCDF files)
5. **NEON Profiler** — Profile `/Users/karnst/Documents/Accelnet/Accelnet/Downloads/geri/geri-working/ri_data/neon_*.parquet` and `/Users/karnst/Documents/Accelnet/Accelnet/Downloads/geri/geri-metadata/neon/` (US sites, Parquet)
...
2. All outputs go in `/Users/karnst/Documents/Accelnet/Accelnet/experiment_logs/runs/ontology_derivation_{timestamp}/`
