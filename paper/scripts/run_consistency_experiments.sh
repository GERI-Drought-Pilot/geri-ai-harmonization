...
get_prompt() {
    case "$1" in
        icos)
            echo "Run the full harmonization pipeline (schema, ingest, research, map, transform, review) on the ICOS METEO L2 data for all 39 sites. Raw data is in /Users/karnst/Documents/Accelnet/Downloads/geri-data/icos/data/. Output harmonized CSVs and Parquets to the project root. Log results to experiment_logs/runs/ with a timestamped run ID." ;;
        neon)
            echo "Run the full harmonization pipeline (schema, ingest, research, map, transform, review) on the NEON data for all available sites. Raw data is in /Users/karnst/Documents/Accelnet/Downloads/geri/geri-working/ri_data/ and metadata in /Users/karnst/Documents/Accelnet/Downloads/geri/geri-metadata/neon/. Output harmonized CSVs and Parquets to the project root. Log results to experiment_logs/runs/ with a timestamped run ID." ;;
        tern)
            echo "Run the full harmonization pipeline (schema, ingest, research, map, transform, review) on the TERN OzFlux L3 NetCDF data for all available sites. Raw data is in /Users/karnst/Documents/Accelnet/Downloads/geri-data/tern/. Output harmonized CSVs and Parquets to the project root. Log results to experiment_logs/runs/ with a timestamped run ID." ;;
        saeon)
            echo "Run the full harmonization pipeline (schema, ingest, research, map, transform, review) on the SAEON flux tower data for all 8 sites. Raw data is in /Users/karnst/Documents/Accelnet/Downloads/geri-data/saeon/. Output harmonized CSVs and Parquets to the project root. Log results to experiment_logs/runs/ with a timestamped run ID." ;;
        elter)
            echo "Run the full harmonization pipeline (schema, ingest, research, map, transform, review) on the eLTER data for all 15 stations. Raw data is in /Users/karnst/Documents/Accelnet/Downloads/geri-data/elter/. Output harmonized CSVs and Parquets to the project root. Log results to experiment_logs/runs/ with a timestamped run ID." ;;
    esac
}
